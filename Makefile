...
run-local: bin/bugsim
	# kubectl run bugsim --image=localhost:5001/bugsim:$(VERSION) --expose --port=80:8080 -- /bugsim server -p 80
	bin/bugsim server -p 8080 -n cloud-native-demo -r 50
